...
Fix login redirect so authenticated users land on the dashboard after signing in
...
Implement: Fix login redirect so authenticated users land on the dashbo
